...
const { updateMeSchema, updateMyPasswordSchema, updateAcatarSchema } = require('../validation/user.validation');
...
userRouter.post('/me/avatar',validateBody(updateAcatarSchema),updateAvatar);
